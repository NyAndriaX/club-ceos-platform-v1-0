    ...
    data: [
      {
        ...
        description: "Plan destiné aux petites entreprises avec un revenu entre 100K et 500K.",
      },
      {
        ...
        description: "Plan pour les grandes entreprises avec un revenu entre 100K et 500K.",
      },
      {
        ...
        description: "Plan destiné aux petites entreprises avec un revenu entre 501K et 999K.",
      },
      {
        ...
        description: "Plan pour les grandes entreprises avec un revenu entre 501K et 999K.",
      },
      {
        ...
        description: "Plan destiné aux petites entreprises avec un revenu entre 1M et 9M.",
      },
      {
        ...
        description: "Plan pour les grandes entreprises avec un revenu entre 1M et 9M.",
      },
      {
        ...
        description: "Plan destiné aux petites entreprises avec un revenu entre 10M et 20M.",
      },
      {
        ...
        description: "Plan pour les grandes entreprises avec un revenu supérieur à 20M.",
      },
    ],
  });
};