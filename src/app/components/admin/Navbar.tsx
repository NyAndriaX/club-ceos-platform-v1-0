...
export const Navbar: React.FC = () => {
  ...
  const isHomePage = pathname === '/pages/admin/home';
    ...
    },
    {
      ...
      template: item => (
        <NavItem
          item={item}
          isHomePage={isHomePage}
          onClick={() => router.push('/pages/admin/registration-requests')}
        />
      ),
    },
    {
      ...
      template: item => (
        <NavItem
          item={item}
          isHomePage={isHomePage}
          onClick={() => router.push('/pages/admin/thematic/list')}
        />
      ),
    },
    {
      ...
      template: item => (
        <NavItem
          item={item}
          isHomePage={isHomePage}
          onClick={() => router.push('/pages/admin/topic/type/list')}
        />
      ),
    },
    {
