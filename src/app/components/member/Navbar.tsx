...
export const Navbar: React.FC = () => {
  ...
  const isHomePage = pathname === '/pages/member/home';

  const accept = async () => {
    await signOut({ callbackUrl: '/pages/unrestricted/login' });
  };
  ...
  const items: MenuItem[] = [
    ...
    },
    {
      ...
      command: () => {
        setVisible(false);
        router.push('/pages/member/interest-center');
      },
    },
    {
      label: ' Membres',
      ...
      command: () => {
        setVisible(false);
        router.push('/pages/member/members/list');
      },
    },
    {
      label: 'Mon compte',
      ...
      command: () => {
        setVisible(false);
        router.push('/pages/member/user/edit');
      },
    },
    {
      label: 'Brouillons',
      ...
      command: () => {
        setVisible(false);
        router.push('/pages/member/topic/draft');
      },
    },
    {
  ...
  return (
    ...
    >
      ...
      >
        <LogoButton
          isHomePage={isHomePage}
          onClick={() => router.push('/pages/member/home')}
        />
        <PanelMenu
          model={items}
