...
import { ReplySection } from '@/app/components/member/topic/details/ReplySection';
import { AuthorProfile } from '@/app/components/member/topic/details/AuthorProfile';
import { TopicContent } from '@/app/components/member/topic/details/TopicContent';
import { TopicHeader } from '@/app/components/member/topic/details/TopicHeader';
  ...
  useEffect(() => {
    const fetchTopicDetails = async () => {
      ...
      try {
        ...
        setTopicReplies(fetchedTopic.reply ?? []);
      } catch (error) {
        console.error(
