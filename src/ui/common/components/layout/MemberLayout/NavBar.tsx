...
import { getRandomDarkColor } from "@/ui/common/utils/getRandomDarkColor";
...
export const NavBar: React.FC = () => {
    ...
    const handleClick = (
        ...
        setPositionLeft(rect.left + (isHomePage ? 255 : 80));
        setVisible(true);
    };
        ...
        <>
                            ...
                            isLoadingFetchAllThemes ?
                                ...
                                : <>
                                    {themes.map((theme, index: number) => (
                                        <div key={index} className="flex flex-row items-center gap-4 text-sm">
            ...
            <div className="fixed h-full z-50">
                <Card
                    ...
                    className="h-full z-50 bg-white"
                >
                    <PanelMenu
                        model={items}
                        className={`flex flex-col gap-2 w-full mt-6 ${isHomePage ? "px-4" : "px-2"
                            }`}
                    />
                </Card>
            </div>
