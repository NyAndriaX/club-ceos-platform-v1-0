                                ...
                                <div className="flex flex-col md:flex-row gap-4 items-start  w-full">
                                    <div className="p-field">
                                        ...
                                        <Field
                                            ...
                                            name="lastName"
                                            type="text"
                                            className={`p-inputtext p-component ${touched.lastName &&
                                                errors.lastName &&
                                    ...
                                    <div className="p-field">
                                        ...
                                        <Field
                                            ...
                                            name="firstName"
                                            type="text"
                                            className={`p-inputtext p-component ${touched.firstName &&
                                                errors.firstName &&
                                                "border border-red-500"
                                                }`}
                                        />
                                ...
                                <div className="flex flex-col md:flex-row gap-4 items-start w-full">
                                    <div className="p-field">
                                        ...
                                        <Field
                                            ...
                                            name="postCode"
                                            type="text"
                                            className={`p-inputtext p-component ${touched.postCode && errors.postCode
                                                ? "border border-red-500"
                                                : ""
                                                }`}
                                        />
                                    ...
                                    <Field name="phoneNumber">
                                        {({ field }: any) => (
                                            <PhoneInput
                                                ...
                                                className={`p-inputtext p-component ${touched.phoneNumber && errors.phoneNumber
                                                    ? "border border-red-500"
                                                    : ""
