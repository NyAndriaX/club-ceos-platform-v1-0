...
export const MembersView = () => {
  ...
  return (
    <main className="flex flex-row justify-center p-4">
      <div className="flex flex-col gap-14 w-4/6">
        <h2 className="text-4xl font-semibold">Annuaire des membres</h2>
              ...
              {filteredUsers().length <= 0 ? (
                ...
                filteredUsers().map((user, index: number) => (
                  <Card
                    ...
                    className="md:w-2/5 shadow-none border border-gray-300 cursor-pointer bg-white hover:bg-gray-200"
