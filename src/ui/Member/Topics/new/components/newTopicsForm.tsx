        ...
        {({ setFieldValue, values, errors, touched }) => (
          <Form className="flex flex-col gap-8 items-start w-full">
            ...
            <div className="p-field">
              ...
              <div
                className={`flex flex-row gap-4 items-center border ${touched.coverImage && errors.coverImage ? 'border-red-500' : 'border-gray-300'} rounded-md bg-white  p-2`}
              >
                <FileUpload
                  mode="basic"
                  ...
                  onSelect={e => {
                    ...
                    setFieldValue(
                      'coverImage',
                      'https://firebase.com/images/cover-images.png',
                    );
                    setSelectFile(file);
                  }}
                />
